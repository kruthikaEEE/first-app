...
import { 
  ...
  TrendingUp, Award, Users, Sparkles, Star, Zap, Cpu, Microscope, Waves
} from 'lucide-react';
  ...
  const sections = [
    {
      ...
      icon: <Waves className="text-cyan-600" />,
      content: [
        { label: "Undergraduate", detail: "German Abitur or equivalent Higher Secondary Certificate (NC varies by subject)." },
        { label: "ISE Program", detail: "International Studies in Engineering: English-taught tracks available." },
        { label: "Graduate Programs", detail: "Bachelor's degree in a related field with strong focus on ECTS compatibility." }
      ]
    },
    {
      title: "Language Proficiency",
      icon: <Globe2 className="text-aqua-400" />,
      content: [
        { label: "German Skills", detail: "DSH-2, TestDaF (TDN 4) or telc C1 Hochschule for German tracks." },
        { label: "English Skills", detail: "IELTS 6.0 - 6.5 or TOEFL iBT 80+ for ISE and English Master's." },
        { label: "Duolingo", detail: "105-115+ (Check specific faculty acceptance for 2026)" }
      ]
    }
  ];

  const stats = [
    { icon: <Users />, label: "Student Pop.", value: "43k+", color: "bg-cyan-800" },
    { icon: <Microscope />, label: "Research Hub", value: "Top 10", color: "bg-teal-600" },
    { icon: <TrendingUp />, label: "Innovation", value: "High", color: "bg-sky-700" },
    { icon: <Award />, label: "Young Uni Rank", value: "Top 20", color: "bg-slate-800" }
  ];

  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      
      {/* Animated Background Blobs - Aqua Theme */}
      ...
      <motion.div style={{ opacity, scale }} className="relative h-[100vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.8 }} className="relative">
            ...
            <h1 className="text-6xl md:text-8xl font-black text-white mb-4 tracking-tight">Duisburg-Essen</h1>
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl mx-auto uppercase tracking-widest">University of the Ruhr Valley</p>
          </motion.div>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-32 space-y-6">
              <motion.div variants={itemVariants} className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl p-8 rounded-[3rem] border border-cyan-100 dark:border-slate-800 shadow-2xl relative overflow-hidden group">
                ...
                <motion.div variants={floatVariants} animate="animate" className="w-16 h-16 bg-gradient-to-br from-cyan-700 to-teal-950 rounded-2xl mb-6 flex items-center justify-center shadow-xl rotate-3 relative">
                  <Landmark size={32} className="text-white relative z-10" />
                </motion.div>
                
                <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-2 leading-tight">Uni <span className="text-cyan-700 italic block">Duisburg-Essen</span></h1>
                ...
                <div className="space-y-4 pt-6 border-t border-cyan-50 dark:border-slate-800">
                  <div className="flex justify-between items-center group/deadline">
                    <span className="text-xs font-black uppercase text-slate-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-cyan-600 transition-colors">
                      <Clock size={14} className="text-cyan-600" /> Winter Semester
                    </span>
                    <span className="font-bold dark:text-white">July 15</span>
                  </div>
                  <div className="flex justify-between items-center group/deadline">
                    <span className="text-xs font-black uppercase text-slate-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-cyan-600 transition-colors">
                      <Clock size={14} className="text-cyan-600" /> Summer Semester
                    </span>
              ...
              <motion.div variants={itemVariants} className="relative bg-gradient-to-br from-cyan-900 via-teal-900 to-slate-950 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "UDE is one of the top 10 research-intensive universities in Germany, bridging the gap between traditional engineering and modern life sciences."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div variants={itemVariants} className="bg-slate-900 text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden border border-slate-800">
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {["Uni-Assist (VPD) Process", "Certified Degree Translation", "Language Certificate", "Letter of Motivation", "Curriculum Vitae (CV)", "Health Insurance Proof"].map((item, i) => (
            ...
            <motion.div variants={itemVariants} className="bg-white dark:bg-slate-900 p-10 rounded-[3rem] border border-cyan-50 dark:border-slate-800 shadow-sm relative overflow-hidden">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {["Intercultural Competence", "Analytical Resilience", "Industrial Interests", "German Language Adaptability"].map((rule, i) => (
                ...
                <motion.div whileHover={{ scale: 1.05 }} className="bg-gradient-to-br from-cyan-900 via-teal-950 to-slate-950 p-8 rounded-[2rem] text-white shadow-2xl relative overflow-hidden">
                  ...
                  <h4 className="text-xl font-black mb-2 relative z-10 flex items-center gap-2"><Award size={24} /> Semester Fee</h4>
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    No tuition fees. Semester contribution (~€330) includes the "NRW-Ticket" for free public transport across the state.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-10 flex flex-col items-center gap-6">
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-2"><Sparkles size={18} /> Apply to UDE</span>
              </motion.button>
              <motion.p animate={{ opacity: [0.5, 1, 0.5] }} transition={{ duration: 2, repeat: Infinity }} className="text-slate-400 font-bold text-xs uppercase tracking-widest flex items-center gap-2">
                <Clock size={14} className="text-cyan-600" /> Winter Semester Admissions: Closing Soon
              </motion.p>
            </motion.div>
