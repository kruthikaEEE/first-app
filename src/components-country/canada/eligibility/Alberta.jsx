  ...
  const sections = [
    {
      ...
      content: [
        { label: "Undergraduate", detail: "High school diploma with 5 subjects; average varies by faculty (80-90%+)." },
        { label: "Faculty Rigor", detail: "Competitive faculties like Engineering/Science prioritize Math/Science GPA." },
        { label: "Graduate Programs", detail: "Bachelor's degree with a minimum 3.0/4.0 GPA in the last two years of study." }
      ]
    },
    {
      ...
      content: [
        { label: "IELTS / TOEFL", detail: "6.5 (no band < 6.0) / 90+ (Required for International applicants)" },
        { label: "GRE / GMAT", detail: "Required for MBA and specific PhD programs; often optional for M.Eng." },
        { label: "Duolingo (DET)", detail: "120+ (Score requirements vary slightly by faculty)" }
      ]
    }
  ];

  const stats = [
    { icon: <Users />, label: "Total Students", value: "40k+", color: "bg-blue-700" },
    { icon: <Microscope />, label: "Research Impact", value: "Top 5", color: "bg-blue-600" },
    { icon: <TrendingUp />, label: "Employment Rate", value: "94%", color: "bg-cyan-600" },
    { icon: <Award />, label: "Global Rank", value: "#110", color: "bg-slate-900" }
  ];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-cyan-400/5 dark:bg-white/5 rounded-full blur-3xl"
        />
      </div>

      {/* --- HERO SECTION: INCREASED TO 85VH TO PREVENT OVERLAP --- */}
      <motion.div style={{ opacity, scale }} className="relative h-[100vh] w-full overflow-hidden">
        ...
        >
          <img 
            src="/assets/colleges/alberta.jpg" 
          ...
          <motion.div 
            ...
            className="absolute inset-0 bg-gradient-to-b from-blue-950/70 via-blue-900/30 to-slate-50 dark:to-slate-950"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/60 via-transparent to-slate-950/40 opacity-70" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.8 }} className="relative">
            <motion.div
              animate={{ boxShadow: ["0 0 20px rgba(30, 64, 175, 0.3)", "0 0 40px rgba(34, 211, 238, 0.4)", "0 0 20px rgba(30, 64, 175, 0.3)"] }}
            ...
            <h1 className="text-6xl md:text-8xl font-black text-white mb-4 tracking-tight">UAlberta</h1>
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl mx-auto">Excellence in Research and Innovation</p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-32 space-y-6">
              <motion.div variants={itemVariants} className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl p-8 rounded-[3rem] border border-blue-100 dark:border-slate-800 shadow-2xl relative overflow-hidden group">
                ...
                <motion.div variants={floatVariants} animate="animate" className="w-16 h-16 bg-gradient-to-br from-blue-700 to-blue-900 rounded-2xl mb-6 flex items-center justify-center shadow-xl rotate-3 relative">
                  <Landmark size={32} className="text-white relative z-10" />
                </motion.div>
                
                <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-2 leading-tight">University of <span className="text-blue-700 italic block">Alberta</span></h1>
                <p className="text-slate-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  ...
                  U15 Research Member • Edmonton, AB
                </p>
                ...
                <div className="space-y-4 pt-6 border-t border-blue-50 dark:border-slate-800">
                  <div className="flex justify-between items-center group/deadline">
                    <span className="text-xs font-black uppercase text-slate-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-blue-700 transition-colors">
                      <Clock size={14} className="text-blue-700" /> Fall Application
                    </span>
                    <span className="font-bold dark:text-white">Mar 01</span>
                  </div>
                  <div className="flex justify-between items-center group/deadline">
                    <span className="text-xs font-black uppercase text-slate-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-blue-700 transition-colors">
                      <Clock size={14} className="text-blue-700" /> Winter Application
                    </span>
                    <span className="font-bold dark:text-white">Oct 01</span>
                  </div>
                </div>
              </motion.div>

              <motion.div variants={itemVariants} className="relative bg-gradient-to-br from-blue-800 via-blue-950 to-cyan-700 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group">
                ...
                <Lightbulb className="mb-4 text-cyan-200" size={32} />
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Alberta uplifts the whole people by being a leader in AI research and Energy transition."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                <motion.div key={idx} variants={itemVariants} whileHover={{ y: -8, rotateY: 2 }} className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-blue-50 dark:border-slate-800 shadow-sm hover:shadow-2xl transition-all relative overflow-hidden group">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-cyan-500/0 to-transparent group-hover:from-blue-500/5 group-hover:via-cyan-500/5 transition-all duration-500" />
                  ...
                  <div className="space-y-4 relative z-10">
                    {section.content.map((item, i) => (
                      <motion.div key={i} whileHover={{ x: 5 }} className="group/item">
                        <p className="text-[10px] font-black uppercase text-slate-400 tracking-tighter group-hover/item:text-blue-700 transition-colors flex items-center gap-2">
            ...
            <motion.div variants={itemVariants} className="bg-slate-900 text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden border border-slate-800">
              <div className="absolute inset-0 opacity-5" style={{ backgroundImage: "linear-gradient(rgba(34, 211, 238, 0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(34, 211, 238, 0.2) 1px, transparent 1px)", backgroundSize: "50px 50px" }} />
              <h2 className="text-3xl font-black mb-8 flex items-center gap-3 relative z-10"><FileText className="text-cyan-400" /> Admission Package</h2>
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {["UAlberta Launchpad Portal", "Statement of Intent (Grads)", "Reference Letters (2-3)", "Transcripts (Interim & Final)", "Resume / Curriculum Vitae", "English Proficiency Evidence"].map((item, i) => (
                  <motion.div key={i} whileHover={{ x: 10, scale: 1.02 }} className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 hover:border-cyan-500/50 transition-all group">
                    <CheckCircle2 size={18} className="text-cyan-400 group-hover:text-blue-400" />
            ...
            <motion.div variants={itemVariants} className="bg-white dark:bg-slate-900 p-10 rounded-[3rem] border border-blue-100 dark:border-slate-800 shadow-sm relative overflow-hidden">
              <div className="flex items-center gap-3 mb-8 relative z-10">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-3xl"><Target className="text-blue-700" size={28} /></div>
                <h2 className="text-3xl font-black dark:text-white tracking-tight">Success Factors</h2>
              </div>
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {["Community Leadership", "Innovation Focus", "Research Alignment", "Academic Breadth"].map((rule, i) => (
                    <motion.div key={i} whileHover={{ x: 10 }} className="flex items-center gap-4 group">
                      <div className="w-2 h-2 rounded-full bg-blue-700 group-hover:bg-cyan-400" />
                      <span className="text-md font-bold text-slate-700 dark:text-slate-300 group-hover:text-blue-700">{rule}</span>
                    </motion.div>
                  ))}
                </div>
                <motion.div whileHover={{ scale: 1.05 }} className="bg-gradient-to-br from-blue-700 via-blue-900 to-slate-950 p-8 rounded-[2rem] text-white shadow-2xl relative overflow-hidden">
                  <p className="text-xs font-black uppercase tracking-widest mb-2 opacity-90 relative z-10 text-cyan-300">Financial Funding</p>
                  <h4 className="text-xl font-black mb-2 relative z-10 flex items-center gap-2"><Award size={24} /> $34M+ Yearly</h4>
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Tuition approx. $30k CAD/yr. International student scholarships range from $5,000 to $30,000 based on merit.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-10 flex flex-col items-center gap-6">
              ...
              >
                <motion.span initial={{ x: "-100%" }} whileHover={{ x: "100%" }} transition={{ duration: 0.6 }} className="absolute inset-0 bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-400" />
              ...
              <motion.p animate={{ opacity: [0.5, 1, 0.5] }} transition={{ duration: 2, repeat: Infinity }} className="text-slate-400 font-bold text-xs uppercase tracking-widest flex items-center gap-2">
                <Clock size={14} className="text-blue-700" /> Application Windows are Open
              </motion.p>
            </motion.div>
