...
const CarnegiemellonEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal schooling with strong academic performance, typically in the top 5–10% of your class." 
        },
        { 
          label: "Core Preparation", 
          detail: "Excellent preparation in Mathematics, Computer Science, Physics, and engineering fundamentals; program-specific prerequisites are strictly evaluated." 
        },
        { 
          label: "Graduate / Master’s Programs", 
          detail: "Bachelor’s degree from a recognized university with strong alignment to the chosen program plus research experience, internships, or technical projects." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "For international students: IELTS 7.0+; TOEFL iBT scores around 100+ are competitive; Duolingo 120+ depending on program requirements." 
        },
        { 
          label: "GRE / GMAT", 
          detail: "GRE is required or strongly recommended for many MS programs; GMAT is typically required for the Tepper School of Business MBA." 
        },
        { 
          label: "Program Specific", 
          detail: "Some programs expect prior coursework in algorithms, advanced mathematics, or systems along with strong coding and analytical skills." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈14%", color: "bg-red-500" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "$100k+", color: "bg-green-500" },
    { icon: <Award />, label: "Top Ranked Fields", value: "CS • AI • Robotics", color: "bg-amber-500" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      >
        ...
        >
          <img 
            src="/assets/colleges/carnegie.jpg" 
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Where Deep Tech Meets Real-World Impact
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  Carnegie Mellon <span className="text-red-800 italic block">University</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Top Tech & Research • Pittsburgh, PA
                </p>
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Carnegie Mellon doesn’t train generalists — it builds elite specialists. Show how you turn deep tech into real impact."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  "Online application via CMU portal",
                  "Statement of Purpose (SOP)",
                  "2–3 Letters of Recommendation",
                  "Official academic transcripts",
                  "Resume / CV (mandatory for graduate)",
                  "Coding samples, portfolio, or research papers (if applicable)"
                ].map((item, i) => (
                  <motion.div 
                    key={i}
            ...
            {/* Selection Focus & Impact with Parallax */}
            <motion.div 
              variants={itemVariants}
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    "Deep technical skills & coding strength",
                    "Research, internships, or technical projects",
                    "Project-driven learning & innovation",
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Undergraduate tuition and fees are around $65k–$67k per year, and CMU offers need-based aid mainly for U.S. citizens, with limited, highly competitive options for international students.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                Deadlines fill fast for 2026 intake
              </motion.p>
            </motion.div>
...
export default CarnegiemellonEligibility;
