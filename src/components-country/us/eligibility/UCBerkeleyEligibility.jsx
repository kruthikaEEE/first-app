...
const UCBerkeleyEligibility = () => {
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈12–15%", color: "bg-red-500" },
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  UC Berkeley <span className="text-red-800 italic block">University of California</span>
                </h1>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Non-resident undergraduates face total tuition and fees of roughly $55k–60k per year, and UC Berkeley offers very limited need-based aid directly to international students, so strong proof of funding is expected. [web:32][web:36][web:38][web:41]
                  </p>
                </motion.div>
              </div>
            </motion.div>
