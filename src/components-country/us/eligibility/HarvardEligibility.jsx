...
const HarvardEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { label: "Undergraduate", detail: "Completion of 12 years of formal schooling; Top 5–10% of class preferred." },
        { label: "GPA Expectation", detail: "No fixed minimum, but exceptional academic rigor is required." },
        { label: "Graduate Programs", detail: "Bachelor's degree from a recognized university with strong field-specific background." }
      ]
    },
    {
      ...
      content: [
        { label: "IELTS / TOEFL", detail: "7.5+ / 100+ (Required for international students)" },
        { label: "GRE / GMAT", detail: "Required for most Graduate/MBA programs; highly competitive scores expected." },
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "3.4%", color: "bg-red-500" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "$160k", color: "bg-green-500" },
    { icon: <Award />, label: "Nobel Laureates", value: "160+", color: "bg-amber-500" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      >
        ...
        >
          <img 
            src="/assets/colleges/harvard.jpeg" 
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Harvard selects future leaders, not just toppers. Prove you can create impact."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {["Common App / Harvard Portal", "Statement of Purpose (SOP)", "Letters of Recommendation", "Academic Transcripts", "Resume (CV)", "Portfolio / Work Samples"].map((item, i) => (
                  <motion.div 
                    key={i}
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {["Leadership & Vision", "Research Excellence", "Extracurricular Mastery", "Community Impact"].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                      whileInView={{ opacity: 1, x: 0 }}
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Harvard provides 100% of demonstrated financial need for all admitted students, including international applicants.
                  </p>
                </motion.div>
              </div>
            </motion.div>
...
export default HarvardEligibility;