...
const AdamMickiewiczEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal schooling with strong overall academic performance. AMU values well-rounded education across sciences and humanities." 
        },
        { 
          label: "Diverse Disciplines", 
          detail: "Excellent performance in relevant subjects for chosen field. Science students need strong math/physics; humanities students need language skills." 
        },
        { 
          label: "Graduate / Master's Programs", 
          detail: "Bachelor's degree from recognized institution with relevant coursework. Research papers, thesis work, or specialized projects enhance applications." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "IELTS 6.0+ or TOEFL iBT 79+ for English-taught programs. Wide range of international programs available with supportive learning environment." 
        },
        { 
          label: "Standardized Tests", 
          detail: "GRE generally not required. Strong academic transcripts and demonstrated engagement in your field of study are valued most." 
        },
        { 
          label: "Field-Specific Assessment", 
          detail: "Some programs may include subject knowledge assessments or interviews to evaluate passion and expertise in chosen discipline." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈26%", color: "bg-indigo-500" },
    { icon: <TrendingUp />, label: "Avg Salary", value: "€40k+", color: "bg-green-500" },
    { icon: <Award />, label: "Top Fields", value: "Sciences • Engineering • Humanities", color: "bg-amber-500" },
    { icon: <Globe2 />, label: "International", value: "12%+", color: "bg-blue-500" }
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-3xl"
        />
      </div>
      ...
      >
        ...
        >
          <img 
            src="/assets/hero-germany.jpg" 
            alt="Adam Mickiewicz University" 
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-900/50 via-transparent to-purple-900/30 opacity-70" />
        </motion.div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            <motion.div
              animate={{ boxShadow: ["0 0 20px rgba(79, 70, 229, 0.3)", "0 0 40px rgba(79, 70, 229, 0.6)", "0 0 20px rgba(79, 70, 229, 0.3)"] }}
            ...
            >
              ...
              Poland's Premier Comprehensive University
            </motion.div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  Adam Mickiewicz <span className="text-indigo-700 italic block">University</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Founded 1919 • Poznań, Poland
                </p>
                ...
                <div className="space-y-4 pt-6 border-t border-gray-100 dark:border-slate-800">
                  {[
                    ...
                    >
                      <span className="text-xs font-black uppercase text-gray-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-indigo-600 transition-colors">
              ...
              <motion.div 
                variants={itemVariants}
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-indigo-800 via-indigo-700 to-indigo-900 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group"
              >
                <motion.div
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "AMU seeks students who combine intellectual depth with diverse interests. Show how you bridge disciplines and think comprehensively."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                >
                  ...
                  <div className="space-y-4 relative z-10">
                    {section.content.map((item, i) => (
                      ...
                      >
                        <p className="text-[10px] font-black uppercase text-gray-400 tracking-tighter group-hover/item:text-indigo-600 transition-colors flex items-center gap-2">
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  ...
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 hover:border-indigo-500/50 hover:bg-white/10 transition-all cursor-pointer group"
                  >
                    <motion.div
                      whileHover={{ rotate: 360, scale: 1.2 }}
                      transition={{ duration: 0.5 }}
                    >
                      <CheckCircle2 size={18} className="text-indigo-500 group-hover:text-green-400 transition-colors" />
                    </motion.div>
            ...
            >
              <motion.div
                ...
                className="absolute -top-10 -right-10 w-40 h-40 bg-indigo-100 dark:bg-indigo-900/20 rounded-full blur-3xl"
              />
              ...
              <div className="flex items-center gap-3 mb-8 relative z-10">
                ...
                <h2 className="text-3xl font-black dark:text-white tracking-tight">What Makes AMU Special</h2>
              </div>
              
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    "Comprehensive programs across all disciplines",
                    "Research-driven approach to learning",
                    "Vibrant intellectual community",
                    "Strong emphasis on student development & career support"
                  ].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <motion.div 
                        ...
                        className="w-2 h-2 rounded-full bg-indigo-600 group-hover:bg-green-500 transition-colors"
                      />
                      <span className="text-md font-bold text-gray-700 dark:text-slate-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{rule}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                <motion.div 
                  ...
                  className="bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 p-8 rounded-[2rem] text-white shadow-2xl shadow-indigo-500/30 relative overflow-hidden"
                >
                  <motion.div
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    €1,500-2,000 per year for international students. Competitive scholarships available for academic merit and demonstrated excellence.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-12 py-6 bg-gradient-to-r from-indigo-800 via-indigo-700 to-indigo-800 text-white rounded-full font-black uppercase tracking-[0.2em] text-sm transition-all shadow-2xl shadow-indigo-500/30 overflow-hidden"
              >
                <motion.span 
                  className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-indigo-500 to-indigo-600"
                  initial={{ x: "-100%" }}
                  whileHover={{ x: "100%" }}
...
export default AdamMickiewiczEligibility;
