...
const AustriaEligibilityDetail = () => {
  ...
  const eligibilityData = {
    "university of vienna": {
      ...
      heroGradient: "from-red-900/70 via-transparent to-red-700/40"
    },
    "tu wien": {
      image: "/assets/hero-germany.jpg",
    ...
    "jku linz": {
      ...
      heroGradient: "from-indigo-900/70 via-transparent to-indigo-700/40"
    }
  };
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              ...
              Austria's Top Research University
            </motion.div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Austrian universities value academic excellence, research potential, and international collaboration. Show how your background aligns with their research-focused programs."
                </p>
              </motion.div>
            </div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    'Students must meet Austrian Student Visa requirements and maintain academic integrity.'
                  ].map((rule, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: -20 }}
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Austrian public universities offer highly affordable tuition rates, especially for EU citizens. Non-EU students pay higher rates but still significantly less than many Western countries. Merit‑based scholarships and research funding are available for strong candidates.
                  </p>
                </motion.div>
              </div>
            </motion.div>
