...
const UniversityOfViennaEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal schooling with strong performance. Austrian universities value foundational knowledge in humanities, sciences, and social sciences." 
        },
        { 
          label: "Core Preparation", 
          detail: "Excellent preparation in Mathematics, Languages (German), History, and critical thinking. Program-specific prerequisites are evaluated." 
        },
        { 
          label: "Graduate / Master's Programs", 
          detail: "Bachelor's degree from a recognized university with research experience and strong academic record. Law and Medicine programs are highly competitive." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "German language proficiency is essential for most programs. TestDaF 4 or equivalent (B2+ level CEFR) required for international students." 
        },
        { 
          label: "English Proficiency", 
          detail: "For English-taught programs: IELTS 6.5+, TOEFL iBT 90+, or Duolingo 110+." 
        },
        { 
          label: "Entrance Exams", 
          detail: "Some programs require entrance exams. Medicine and Law have competitive national exams. Engineering programs value strong Math preparation." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈25%", color: "bg-blue-500" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "€55k+", color: "bg-green-500" },
    { icon: <Award />, label: "Top Fields", value: "Medicine • Law • Engineering", color: "bg-amber-500" },
    { icon: <Globe2 />, label: "Established", value: "1365", color: "bg-blue-400" }
  ];
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              ...
              Europe's Oldest German University
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Six Centuries of Academic Excellence
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  University of Vienna <span className="text-blue-700 italic block">Austria</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Historic Excellence • Vienna, Austria
                </p>
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "At Vienna University, you'll study where Mozart learned, where Freud taught. Academic rigor meets European cultural heritage."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  "Online application form with personal statement",
                  "High school or bachelor's transcripts (certified)",
                  "2 Letters of Recommendation",
                  "Proof of German language proficiency (TestDaF, ÖSD, etc.)",
                  "Curriculum Vitae (for graduate programs)",
                  "Research proposal (for some Master's programs)"
                ].map((item, i) => (
                  <motion.div 
                    key={i}
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    "Contribution to academic or cultural community",
                    "Diverse international perspectives & experiences"
                  ].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    EU/EEA citizens: minimal tuition (€696/semester). Non-EU students: €1,500/semester. Scholarships available for excellence and financial need.
                  </p>
                </motion.div>
              </div>
            </motion.div>
...
export default UniversityOfViennaEligibility;
