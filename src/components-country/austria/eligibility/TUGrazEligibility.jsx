...
const TUGrazEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal education with solid performance in STEM subjects. Materials science and engineering background valued." 
        },
        { 
          label: "Core Preparation", 
          detail: "Strong foundation in Mathematics, Physics, Chemistry, and Computer Science. Practical laboratory experience is beneficial." 
        },
        { 
          label: "Graduate / Master's Programs", 
          detail: "Bachelor's degree in engineering, IT, or materials science. GPA 3.0+ with research experience or technical internships." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "German proficiency (TestDaF 3+ or B2 level) for German-taught programs. English-taught masters available with IELTS 6.5+." 
        },
        { 
          label: "Entrance Exam", 
          detail: "Some programs require entrance exam in Mathematics and Physics. Technical aptitude and problem-solving skills are assessed." 
        },
        { 
          label: "Graduate Assessment", 
          detail: "GRE recommended for master's applications. Portfolio of practical projects or research work valued highly." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈22%", color: "bg-amber-500" },
    { icon: <TrendingUp />, label: "Avg Starting Salary", value: "€52k+", color: "bg-green-500" },
    { icon: <Award />, label: "Top Fields", value: "Engineering • IT • Materials Science", color: "bg-amber-600" },
    { icon: <Globe2 />, label: "Founded", value: "1811", color: "bg-amber-400" }
  ];
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  TU Graz <span className="text-amber-700 italic block">Austria</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Sustainable Innovation • Graz, Austria
                </p>
                ...
                <div className="space-y-4 pt-6 border-t border-gray-100 dark:border-slate-800">
                  {[
                    ...
                    >
                      <span className="text-xs font-black uppercase text-gray-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-amber-600 transition-colors">
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "TU Graz pioneers sustainable engineering. Join leaders reshaping technology with environmental responsibility at its core."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                >
                  ...
                  <div className="space-y-4 relative z-10">
                    {section.content.map((item, i) => (
                      ...
                      >
                        <p className="text-[10px] font-black uppercase text-gray-400 tracking-tighter group-hover/item:text-amber-600 transition-colors flex items-center gap-2">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  "Online application via TU Graz portal",
                  "High school transcripts or bachelor's degree",
                  "2 References from previous instructors/mentors",
                  "German language certificate (TestDaF 3+) or English proof",
                  "Technical portfolio (projects, GitHub, lab work)",
                  "Essay on research interests in sustainability/materials"
                ].map((item, i) => (
                  <motion.div 
                    key={i}
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8 relative z-10">
                ...
                <h2 className="text-3xl font-black dark:text-white tracking-tight">What We Value</h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                  ...
                  {[
                    ...
                    >
                      <motion.div 
                        ...
                        className="w-2 h-2 rounded-full bg-amber-600 group-hover:bg-green-500 transition-colors"
                      />
                ...
                <motion.div 
                  ...
                  className="bg-gradient-to-br from-amber-500 via-amber-600 to-amber-700 p-8 rounded-[2rem] text-white shadow-2xl shadow-amber-500/30 relative overflow-hidden"
                >
                  <motion.div
                    animate={{
                      scale: [1, 1.5, 1],
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    EU/EEA: €696/semester. Non-EU: €1,500/semester. Scholarships for sustainability-focused and high-achieving international students.
                  </p>
                </motion.div>
              </div>
            </motion.div>
...
export default TUGrazEligibility;
