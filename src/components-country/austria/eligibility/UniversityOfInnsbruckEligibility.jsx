...
const UniversityOfInnsbruckEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        { 
          ...
          detail: "Completion of 12 years of formal education with good overall performance. Diverse programs welcome varied academic backgrounds." 
        },
        { 
          label: "Core Preparation", 
          detail: "Strong foundation in relevant subjects. Science and Engineering programs require Mathematics and Physics proficiency." 
        },
        { 
          label: "Graduate / Master's Programs", 
          detail: "Bachelor's degree from recognized institution. GPA 3.0+ preferred. Work experience and research projects valued." 
        }
      ]
    },
    {
      ...
      content: [
        { 
          ...
          detail: "German proficiency (TestDaF 3+ or B2 level) for German programs. English-taught programs available with IELTS 6.5+." 
        },
        { 
          label: "Entrance Assessment", 
          detail: "Some science and engineering programs have entrance exams. General entrance exams for non-EU students in some cases." 
        },
        { 
          label: "Graduate Entry", 
          detail: "GRE recommended for master's programs. Statement of intent and research interests required." 
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: "Acceptance Rate", value: "≈28%", color: "bg-purple-500" },
    ...
    { icon: <Globe2 />, label: "Founded", value: "1677", color: "bg-purple-400" }
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-purple-400/10 dark:bg-purple-400/5 rounded-full blur-3xl"
        />
      </div>
      ...
      >
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/50 via-transparent to-purple-800/30 opacity-70" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              ...
              Alpine Excellence in Diversity
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Nature's Laboratory for Discovery
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  University of Innsbruck <span className="text-purple-700 italic block">Austria</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Mountain Education • Innsbruck, Austria
                </p>
                ...
                <div className="space-y-4 pt-6 border-t border-gray-100 dark:border-slate-800">
                  {[
                    ...
                    >
                      <span className="text-xs font-black uppercase text-gray-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-purple-600 transition-colors">
              ...
              <motion.div 
                variants={itemVariants}
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-purple-700 via-purple-600 to-purple-800 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group"
              >
                <motion.div
                  animate={{
                    rotate: [0, 360],
                ...
                <Lightbulb className="mb-4 text-purple-200" size={32} />
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Innsbruck combines alpine charm with academic excellence. Study in an inspiring environment where nature fuels discovery."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/0 via-purple-500/0 to-purple-500/0 group-hover:from-purple-500/5 group-hover:via-purple-500/5 group-hover:to-purple-500/5 transition-all duration-500" />
                  ...
                  <div className="space-y-4 relative z-10">
                    {section.content.map((item, i) => (
                      ...
                      >
                        <p className="text-[10px] font-black uppercase text-gray-400 tracking-tighter group-hover/item:text-purple-600 transition-colors flex items-center gap-2">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  "Online application via Innsbruck portal",
                  "High school diploma or bachelor's transcripts",
                  "2 Academic references",
                  "Language proficiency documentation",
                  "Motivation letter explaining program choice",
                  "CV with educational/professional background"
                ].map((item, i) => (
                  <motion.div 
                    key={i}
                  ...
                  >
                    <motion.div
                      ...
                      transition={{ duration: 0.5 }}
                    >
                      <CheckCircle2 size={18} className="text-purple-500 group-hover:text-green-400 transition-colors" />
                    </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    "Strong academic foundation and motivation",
                    "Interest in interdisciplinary learning",
                    "Appreciation for quality of life and nature"
                  ].map((rule, i) => (
                    <motion.div 
                      key={i} 
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <motion.div 
                        ...
                        className="w-2 h-2 rounded-full bg-purple-600 group-hover:bg-green-500 transition-colors"
                      />
                      <span className="text-md font-bold text-gray-700 dark:text-slate-300 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">{rule}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                <motion.div 
                  ...
                  className="bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 p-8 rounded-[2rem] text-white shadow-2xl shadow-purple-500/30 relative overflow-hidden"
                >
                  <motion.div
                    animate={{
                      scale: [1, 1.5, 1],
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    EU/EEA: €696/semester. Non-EU: €1,500/semester. Scholarships and financial aid available for qualifying international students.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-12 py-6 bg-gradient-to-r from-purple-700 via-purple-600 to-purple-700 text-white rounded-full font-black uppercase tracking-[0.2em] text-sm transition-all shadow-2xl shadow-purple-500/30 overflow-hidden"
              >
                <motion.span 
...
export default UniversityOfInnsbruckEligibility;
