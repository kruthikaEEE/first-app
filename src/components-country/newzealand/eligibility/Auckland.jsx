  ...
  const sections = [
    {
      ...
      content: [
        { label: "Undergraduate", detail: "GPE (Grade Point Equivalent) of 3.0+ based on Year 13 or equivalent international results." },
        { label: "Faculty Entry", detail: "Specific Rank Scores required for Engineering, Law, and Health Sciences." },
        { label: "Graduate Programs", detail: "Completed Bachelor's degree with a GPE of 4.0-5.0 (B average) in senior courses." }
      ]
    },
    {
      ...
      content: [
        { label: "IELTS Academic", detail: "6.0 (no band < 5.5) for UG; 6.5+ for PG (Required for most internationals)." },
        { label: "TOEFL iBT", detail: "80+ (Writing 21) for UG; 90+ (Writing 21) for Post-graduate applicants." },
        { label: "PTE Academic", detail: "50+ for UG; 58+ for PG (Varies by specific program requirements)." }
      ]
    }
  ];

  const stats = [
    { icon: <Users />, label: "Total Students", value: "40k+", color: "bg-blue-900" },
    { icon: <Microscope />, label: "NZ Research", value: "#1", color: "bg-blue-800" },
    { icon: <TrendingUp />, label: "Graduate outcomes", value: "Top 70", color: "bg-blue-700" },
    { icon: <Award />, label: "QS Global Rank", value: "#65", color: "bg-slate-900" }
  ];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-20 right-20 w-96 h-96 bg-blue-900/10 dark:bg-blue-800/10 rounded-full blur-3xl"
        />
        <motion.div 
          animate={{ x: [0, -150, 0], y: [0, 100, 0], scale: [1, 1.3, 1], rotate: [0, -90, 0] }}
          transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
          className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-blue-400/5 dark:bg-white/5 rounded-full blur-3xl"
        />
      </div>
      ...
      <motion.div style={{ opacity, scale }} className="relative h-[100vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.8 }} className="relative">
            ...
            <h1 className="text-6xl md:text-8xl font-black text-white mb-4 tracking-tight">UAuckland</h1>
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl mx-auto">New Zealand's World-Ranked University</p>
          </motion.div>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-32 space-y-6">
              <motion.div variants={itemVariants} className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl p-8 rounded-[3rem] border border-blue-100 dark:border-slate-800 shadow-2xl relative overflow-hidden group">
                ...
                <motion.div variants={floatVariants} animate="animate" className="w-16 h-16 bg-gradient-to-br from-blue-900 to-black rounded-2xl mb-6 flex items-center justify-center shadow-xl rotate-3 relative">
                  <Landmark size={32} className="text-white relative z-10" />
                </motion.div>
                
                <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-2 leading-tight">University of <span className="text-blue-900 italic block">Auckland</span></h1>
                ...
                <div className="space-y-4 pt-6 border-t border-blue-50 dark:border-slate-800">
                  <div className="flex justify-between items-center group/deadline">
                    ...
                    <span className="font-bold dark:text-white">Dec 08</span>
                  </div>
                  <div className="flex justify-between items-center group/deadline">
                    <span className="text-xs font-black uppercase text-slate-400 tracking-widest flex items-center gap-2 group-hover/deadline:text-blue-900 transition-colors">
                      <Clock size={14} className="text-blue-900" /> Semester 2 (July)
                    </span>
                    <span className="font-bold dark:text-white">July 04</span>
                  </div>
                </div>
              </motion.div>

              <motion.div variants={itemVariants} className="relative bg-gradient-to-br from-blue-900 via-slate-900 to-blue-800 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group">
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Building a sustainable future through innovation and Pacific-centered research excellence."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div variants={itemVariants} className="bg-slate-900 text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden border border-slate-800">
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {["Applicant Portal (Student Services Online)", "Statement of Purpose (Masters/PhD)", "Two Academic References", "Certified Academic Transcripts", "Passport / Identity Documentation", "CV & Evidence of Work (Specialist Programs)"].map((item, i) => (
            ...
            <motion.div variants={itemVariants} className="bg-white dark:bg-slate-900 p-10 rounded-[3rem] border border-blue-100 dark:border-slate-800 shadow-sm relative overflow-hidden">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {["Critical Thinking Ability", "Holistic Participation", "English Competency", "Cultural Awareness"].map((rule, i) => (
                ...
                <motion.div whileHover={{ scale: 1.05 }} className="bg-gradient-to-br from-blue-900 via-blue-950 to-slate-950 p-8 rounded-[2rem] text-white shadow-2xl relative overflow-hidden">
                  <p className="text-xs font-black uppercase tracking-widest mb-2 opacity-90 relative z-10 text-blue-300">Scholarship Support</p>
                  <h4 className="text-xl font-black mb-2 relative z-10 flex items-center gap-2"><Award size={24} /> $10k - $20k High Achiever</h4>
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Tuition approx. $35k-$50k NZD/yr. International Excellence Scholarships awarded to top tier applicants.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-10 flex flex-col items-center gap-6">
              <motion.button 
                ...
                className="group relative px-12 py-6 bg-gradient-to-r from-blue-900 via-blue-950 to-blue-900 text-white rounded-full font-black uppercase tracking-[0.2em] text-sm transition-all shadow-2xl overflow-hidden"
              >
