// components-country/australia/uos-eligibility.jsx
...
const UosEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          detail:
            'Good preparation in Mathematics, Sciences (especially Physics/Chemistry for STEM), and English / analytical writing; some degrees have mandatory subject prerequisites.'
        },
        {
      ...
      content: [
        {
          ...
          detail:
            'IELTS 6.5–7.0 overall (no band below 6.0) or TOEFL iBT 85+ or PTE Academic 61–68+ for most programs; waivers may be possible based on prior English‑medium education.'
        },
        {
          label: 'Program Expectations',
          detail:
            'Highly ranked and professional programs may require higher English scores, stronger writing samples, and evidence of communication skills.'
        },
        {
          label: 'Prerequisite Subjects',
          detail:
            'Competitive degrees can specify prerequisite subjects or prior coursework in areas such as advanced mathematics, sciences, economics, or related fields.'
        }
      ]
    }
  ];
  ...
  // stats chips
  const stats = [
    { icon: <Users />, label: 'Prestige in AU', value: '#1 Oldest', color: 'bg-red-600' },
    { icon: <TrendingUp />, label: 'Avg Grad Salary', value: 'A$70k+', color: 'bg-green-500' },
    { icon: <Award />, label: 'Global Rank', value: 'Top 40', color: 'bg-amber-500' },
    { icon: <Globe2 />, label: 'International Students', value: '45%+', color: 'bg-blue-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      {/* HERO with uos.avif and bg-red-700 tint */}
      <motion.div style={{ opacity, scale }} className="relative h-[70vh] w-full overflow-hidden">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-red-700/70 via-transparent to-red-700/40 opacity-80" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              ...
              Oldest & Globally Respected in Australia
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Prestige, global recognition, and strong employability in one campus.
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  University of
                  <span className="text-red-700 dark:text-red-400 italic block">Sydney</span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Oldest university in Australia • Sydney CBD
                </p>
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Sydney wants applicants who mix strong academics with leadership, research
                  interest, and the ability to thrive in a global environment."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-red-500/0 via-rose-500/0 to-orange-500/0 group-hover:from-red-500/5 group-hover:via-rose-500/5 group-hover:to-orange-500/5 transition-all duration-500" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  'Online application via University of Sydney portal',
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    'Strong focus on academic consistency and subject relevance.',
                    'Communication and analytical skills plus ethics and integrity are important.',
                    'Students must meet Australian Student Visa (subclass 500) regulations.'
                  ].map((rule, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: -20 }}
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-red-600 via-red-700 to-rose-600 p-8 rounded-[2rem] text-white shadow-2xl shadow-red-500/30 relative overflow-hidden"
                >
                  <motion.div
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Many international programs sit around A$45,000–A$55,000 per year. Merit‑based
                    scholarships and funded research opportunities exist, but are competitive and
                    performance‑driven.
                  </p>
                </motion.div>
              </div>
            ...
            >
              ...
              >
                <motion.span
                  className="absolute inset-0 bg-gradient-to-r from-red-500 via-rose-400 to-red-500"
                  initial={{ x: '-100%' }}
                  whileHover={{ x: '100%' }}
              ...
              >
                ...
                Apply early for better scholarship & visa timelines
              </motion.p>
            </motion.div>
          </div>
        </div>
