// components-country/australia/unimelb-eligibility.jsx
...
const UnimelbEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          detail:
            'Solid preparation in Mathematics, Sciences (especially Physics/Chemistry for STEM), and English / analytical writing; some courses have subject‑specific prerequisites.'
        },
        {
          label: 'Graduate / Master’s Programs',
          detail:
            'Bachelor’s degree from a recognized university with strong alignment to the selected program, plus relevant academic background, projects, or work experience.'
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          detail:
            'IELTS 6.5–7.0 overall (no band below 6.0) or TOEFL iBT around 79–94+ or PTE 58–65+; waivers may apply if prior education meets the university’s English criteria.'
        },
        {
          label: 'Program Requirements',
          detail:
            'Some competitive programs may ask for higher English scores or additional evidence of academic writing and communication skills.'
        },
        {
          label: 'Academic Strength',
          detail:
            'Competitive applicants show consistent grades, rigorous subject choices, and strong performance in prerequisites relevant to their intended major.'
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: 'Prestige in Australia', value: '#1', color: 'bg-blue-600' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      {/* Hero with parallax um.jpg and bg-blue-900 tint */}
      <motion.div style={{ opacity, scale }} className="relative h-[70vh] w-full overflow-hidden">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 via-transparent to-blue-900/40 opacity-80" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            >
              ...
              Australia’s #1 Prestige University
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Research‑intensive, globally ranked, and located in the heart of Melbourne.
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-2 leading-tight">
                  University of
                  <span className="text-blue-900 dark:text-blue-400 italic block">
                    Melbourne
                  </span>
                </h1>
                <p className="text-gray-500 dark:text-slate-400 font-medium mb-6 flex items-center gap-2">
                  <Star size={16} className="text-amber-400 fill-amber-400" />
                  Australia’s most prestigious research university
                </p>
              ...
              >
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "Melbourne looks for students who combine academic excellence with curiosity,
                  global mindset, and readiness for a research‑oriented environment."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  'Online application via University of Melbourne portal',
                  'Official academic transcripts',
                  'Statement of Purpose / Personal Statement (for postgraduate)',
                  'Letters of Recommendation (program dependent)',
                  'Resume / CV for many master’s programs',
                  'Portfolio or research work for design / research‑heavy courses (if applicable)'
                ].map((item, i) => (
                  <motion.div
                    key={i}
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    'Analytical and communication skills are highly valued.',
                    'Students must meet Australian Student Visa (subclass 500) rules and maintain academic integrity.'
                  ].map((rule, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: -20 }}
                ...
                >
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Typical international tuition ranges around A$45,000–A$55,000 per year depending
                    on the faculty. Merit‑based scholarships and fully funded research options are
...
export default UnimelbEligibility;
