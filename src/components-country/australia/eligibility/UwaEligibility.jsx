// components-country/australia/uwa-eligibility.jsx
...
const UwaEligibility = () => {
      ...
      content: [
        {
          ...
          detail:
            'Completion of 12 years of formal schooling with strong academic performance, typically in the top 15–20% of your class.'
        },
        {
          label: 'Core Preparation',
          detail:
            'Good preparation in Mathematics, Sciences (especially Physics/Chemistry for STEM), and English / analytical writing; some programs have subject‑specific prerequisites.'
        },
        {
          label: 'Graduate / Master’s Programs',
          detail:
            'Bachelor’s degree from a recognised university with strong alignment to the chosen program plus relevant projects, research exposure, or work experience.'
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          detail:
            'IELTS 6.5 overall (no band below 6.0) or TOEFL iBT around 82+ or PTE Academic 64+ for most programs; English waivers may be possible for eligible prior education.[web:191][web:192]'
        },
        {
          label: 'Program Expectations',
          detail:
            'Some competitive programs, especially in engineering, data, and business, may expect higher grades, solid quantitative skills, and evidence of independent learning.'
        },
        {
          label: 'Prerequisite Subjects',
          detail:
            'Selected degrees can require specific prerequisite subjects or prior coursework in mathematics, sciences, or discipline‑specific foundations.'
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: 'Group of Eight', value: 'Go8', color: 'bg-emerald-700' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      {/* HERO with uwa.jpg and bg-emerald-700 tint */}
      <motion.div style={{ opacity, scale }} className="relative h-[70vh] w-full overflow-hidden">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-700/70 via-transparent to-emerald-700/40 opacity-80" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              Research‑focused teaching with strong links to mining, energy, and engineering sectors.
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <motion.div
                  ...
                  animate="animate"
                  className="w-16 h-16 bg-gradient-to-br from-emerald-700 to-emerald-500 rounded-2xl mb-6 flex items-center justify-center shadow-xl rotate-3 relative"
                >
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
              ...
              <motion.div
                variants={itemVariants}
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-emerald-900 via-emerald-700 to-emerald-900 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group"
              >
                <motion.div
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "UWA looks for students who mix strong fundamentals with interest in engineering,
                  energy, mining, sciences, or research‑driven careers."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/0 via-teal-500/0 to-lime-500/0 group-hover:from-emerald-500/5 group-hover:via-teal-500/5 group-hover:to-lime-500/5 transition-all duration-500" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  'Online application via UWA Application Portal',
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 hover:border-emerald-400/60 hover:bg-white/10 transition-all cursor-pointer group"
                  >
                    <motion.div
                      whileHover={{ rotate: 360, scale: 1.2 }}
                      transition={{ duration: 0.5 }}
            ...
            >
              <motion.div
                ...
                className="absolute -top-10 -right-10 w-40 h-40 bg-emerald-100 dark:bg-emerald-900/25 rounded-full blur-3xl"
              />
              ...
              <div className="flex items-center gap-3 mb-8 relative z-10">
                <motion.div
                  ...
                  className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-3xl"
                >
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    ...
                    'Strong emphasis on academic consistency, subject relevance, and research or industry alignment.',
                    'Academic integrity and professional conduct are core expectations.',
                    'Students must comply with Australian Student Visa (subclass 500) requirements.[web:195]'
                  ].map((rule, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <motion.div
                        ...
                        className="w-2 h-2 rounded-full bg-emerald-600 group-hover:bg-emerald-400 transition-colors"
                      />
                      <span className="text-md font-bold text-gray-700 dark:text-slate-300 group-hover:text-emerald-700 dark:group-hover:text-emerald-300 transition-colors">
                        {rule}
                      </span>
                    </motion.div>
                  ))}
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-600 p-8 rounded-[2rem] text-white shadow-2xl shadow-emerald-500/30 relative overflow-hidden"
                >
                  <motion.div
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Many UWA international programs sit roughly in the A$38,000–50,000 per‑year
                    tuition band, with merit‑based scholarships and funded research places available
                    on a competitive basis.[web:193][web:196]
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-12 py-6 bg-gradient-to-r from-emerald-800 via-emerald-700 to-emerald-800 text-white rounded-full font-black uppercase tracking-[0.2em] text-sm transition-all shadow-2xl shadow-emerald-500/40 overflow-hidden"
              >
                <motion.span
                  className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-teal-400 to-emerald-500"
                  initial={{ x: '-100%' }}
                  whileHover={{ x: '100%' }}
