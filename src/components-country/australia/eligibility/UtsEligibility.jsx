// components-country/australia/uts-eligibility.jsx
...
const UtsEligibility = () => {
  ...
  const sections = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          detail:
            'Adequate preparation in Mathematics, Sciences for STEM, and English / communication skills; some degrees have mandatory subject prerequisites.'
        },
        {
          label: 'Graduate / Master’s Programs',
          detail:
            'Bachelor’s degree from a recognised university with academic alignment to the chosen program; practical projects, internships, or relevant work experience are highly valued.'
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          detail:
            'Common benchmarks are IELTS 6.5 overall (no band below 6.0), TOEFL iBT around 79–93, or PTE Academic about 58–64, with some courses requiring higher sub‑scores.[web:218][web:219][web:221]'
        },
        {
          label: 'Program Expectations',
          detail:
            'Data, IT, and Engineering programs may expect stronger quantitative skills, coding experience, and evidence of applied problem‑solving.'
        },
        {
          label: 'Prerequisite Subjects',
          detail:
            'Many technical and analytics degrees specify prerequisite subjects or prior coursework in mathematics, computing, or related quantitative areas.'
        }
      ]
    }
  ];
  ...
  const stats = [
    { icon: <Users />, label: 'City Campus', value: 'CBD', color: 'bg-blue-600' },
    { icon: <TrendingUp />, label: 'Employability Focus', value: 'High', color: 'bg-green-500' },
    { icon: <Award />, label: 'Global Rank', value: 'Top 150', color: 'bg-amber-500' },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 pb-20 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-blue-600/10 dark:bg-blue-600/5 rounded-full blur-3xl"
        />
      </div>

      {/* HERO with uts.webp and bg-blue-600 tint */}
      <motion.div style={{ opacity, scale }} className="relative h-[70vh] w-full overflow-hidden">
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600/75 via-transparent to-blue-600/40 opacity-80" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-medium max-w-2xl">
              A modern, industry‑focused university in the heart of Sydney’s tech and business
              ecosystem.
            </p>
          </motion.div>
        </div>
            ...
            <div className="lg:sticky lg:top-32 space-y-6">
              ...
              >
                ...
                <motion.div
                  ...
                  animate="animate"
                  className="w-16 h-16 bg-gradient-to-br from-blue-700 to-blue-500 rounded-2xl mb-6 flex items-center justifyCenter shadow-xl rotate-3 relative"
                >
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
              ...
              <motion.div
                variants={itemVariants}
                whileHover={{ scale: 1.02 }}
                className="relative bg-gradient-to-br from-blue-900 via-blue-700 to-blue-900 p-8 rounded-[2.5rem] text-white shadow-2xl overflow-hidden group"
              >
                <motion.div
                ...
                <p className="text-sm font-medium leading-relaxed italic relative z-10">
                  "UTS suits industry‑oriented learners who like applied projects, internships, and
                  building a strong portfolio alongside their degree."
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {sections.map((section, idx) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-sky-500/0 to-cyan-500/0 group-hover:from-blue-500/5 group-hover:via-sky-500/5 group-hover:to-cyan-500/5 transition-all duration-500" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4 relative z-10">
                {[
                  'Online application via UTS Application Portal',
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
                <div className="space-y-4">
                  {[
                    'Admissions are merit‑based with a strong industry focus.',
                    'UTS emphasises practical skills, employability, and applied learning and innovation.',
                    'Academic consistency and integrity are non‑negotiable expectations.',
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-blue-600 via-sky-600 to-cyan-500 p-8 rounded-[2rem] text-white shadow-2xl shadow-blue-500/30 relative overflow-hidden"
                >
                  <motion.div
                  ...
                  <p className="text-sm font-medium leading-relaxed relative z-10">
                    Several UTS degrees price in the A$40,000–50,000 per‑year range for
                    international students, with merit‑based and industry‑linked scholarships and
                    partial fee waivers available on a competitive basis.[web:219][web:223][web:224]
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-12 py-6 bg-gradient-to-r from-blue-800 via-blue-700 to-blue-800 text-white rounded-full font-black uppercase tracking-[0.2em] text-sm transition-all shadow-2xl shadow-blue-500/40 overflow-hidden"
              >
                <motion.span
